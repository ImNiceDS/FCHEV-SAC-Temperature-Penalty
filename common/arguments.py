...
def get_args():
    ...
    parser.add_argument("--scenario_name", type=str, default="MixValid",     # 학습/평가시 변경 ★★★★★★★★★★
                        help="name of driving cycle data")                             

    # CLTC_P  Standard_ChinaCity, CLTCP_WVUSUB_WVUINTER, WVUCITY_HWFET, CLTCP_WVUINTER
    parser.add_argument("--save_dir", type=str, default="./test9", help="directory in which saves training data and model")
    parser.add_argument("--log_dir", type=str, default="./test9", help="directory in which saves logs")
    ...
    parser.add_argument("--load_episode", type=int, default=86)    # ★★★★★★★★★★ 1부터 세서 oo 번째
    parser.add_argument("--load_scenario_name", type=str, default="MixTrain_w100_LR1e-03_v1")
    parser.add_argument("--load_dir", type=str, default="/root/Reinforcement/Project/test8_SAC_CS_Beta") # ★★★★★★★★★★
