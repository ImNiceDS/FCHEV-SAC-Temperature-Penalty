...
def get_driving_cycle(cycle_name):
    cycle_dir = "/root/Reinforcement/Project/project-data-main/standard_driving_cycles/mat-data/"
...
def get_driving_cycle_v2(cycle_name):
    cycle_dir = "/root/Reinforcement/Project/project-data-main/standard_driving_cycles/xls-data/"
