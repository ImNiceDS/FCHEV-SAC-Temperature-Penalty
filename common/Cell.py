...
class CellModel_2:
    def __init__(self):
        ...
        data_dir = "/root/Reinforcement/Project/project-data-main/HEV_data/"                           # ★★★★★★★★★★★★★
    ...
    def run_cell(self, P_batt, paras_list):
        ...
        out_info = {'SOC': SOC_new, 'SOH': SOH_new, 'soc_deriv': soc_deriv,
                    ...
                    'P_batt': P_batt/1000, 'tep_a': Tep_a_new,'tep_c': Tep_c_new, 'dsoh': dsoh}
