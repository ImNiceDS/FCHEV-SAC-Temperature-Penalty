...
def get_driving_cycle(cycle_name):
    cycle_dir = "/content/drive/MyDrive/Colab Notebooks/25-2 Reinforce/Project/project-data-main/standard_driving_cycles/mat-data/"
...
def get_driving_cycle_v2(cycle_name):
    cycle_dir = "/content/drive/MyDrive/Colab Notebooks/25-2 Reinforce/Project/project-data-main/standard_driving_cycles/xls-data/"
